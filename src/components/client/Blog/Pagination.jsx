  ...
  return (
    <div className="flex justify-center bg-white py-10 ">
      <ul className="flex items-center justify-center gap-1">
        <li>
          <button className="inline-flex h-10 items-center justify-center gap-2 rounded-lg px-4 py-2 text-base font-medium text-dark hover:bg-gray-2 ">
            <span>
              <svg
                width="17"
                height="17"
        ...
        <li>
          <button className="flex h-10 min-w-10 items-center justify-center rounded-lg px-2 text-dark hover:bg-gray-2 ">
            1
          </button>
        </li>
        <li>
          <button className="flex h-10 min-w-10 items-center justify-center rounded-lg px-2 text-dark shadow-sm hover:bg-gray-2 ">
            2
          </button>
        </li>
        <li>
